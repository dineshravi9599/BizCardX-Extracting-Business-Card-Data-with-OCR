...
icon = Image.open(r"C:\Users\DINESH RAVI\Desktop\image.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By DINESH RAVI",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *DINESH RAVI*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\DINESH RAVI\Desktop\image.jpg"), width=500)
